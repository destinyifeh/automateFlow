...
export const HowItWorksSection = (): JSX.Element => {
  return (
    <section className="relative w-full flex flex-col lg:flex-row items-start gap-8 lg:gap-12 py-12 px-4 max-w-[1568px] mx-auto">
      ...
      <div className="flex-1 flex flex-col items-start gap-8 lg:gap-12 pt-2">
        <Badge
          variant="outline"
          className="h-16 px-6 bg-white/10 rounded-[30px] border-none backdrop-blur-[2.0px] backdrop-brightness-[110%] shadow-[inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_1px_rgba(0,0,0,0.1)]"
        >
          <span className="[font-family:'Abhaya_Libre_SemiBold-Regular',Helvetica] font-normal text-[#8d5241] text-[40px] tracking-[0] leading-[normal]">
            About Us
          </span>
        </Badge>

        <h2 className="[font-family:'Abhaya_Libre_ExtraBold-Regular',Helvetica] font-normal text-[40px] tracking-[0] leading-[normal]  animate-fade-in  [--animation-delay:400ms]">
        ...
        <div className="[font-family:'Abhaya_Libre_ExtraBold-Regular',Helvetica] font-normal text-[#8d5241] text-[32px] tracking-[0] leading-[normal] space-y-8  animate-fade-in  [--animation-delay:600ms]">
          <p>
